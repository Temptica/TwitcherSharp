...
/// </summary>
public partial class Choices : Resource, ITwitcherSharp<Choices>
{
    private GodotObject _data;
	public string Title { get; set; }
    /// <summary> 
    /// Transforms the godot data into a Choices object.
    /// </summary> 
    public static Choices FromObject(GodotObject data)
    {
        return new Choices
        {
