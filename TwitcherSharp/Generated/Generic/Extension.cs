...
///  
/// </summary>
public partial class Extension : Resource, ITwitcherSharp<Extension>
{
    ...
    /// <summary> 
    /// Transforms the godot data into a Extension object.
    /// </summary> 
    public static Extension FromObject(GodotObject data)
    {
        return new Extension
        {
			...
			IconUrls = data.Get("icon_urls").As<IconUrls>(),
