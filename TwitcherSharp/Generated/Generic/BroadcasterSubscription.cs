...
///  
/// </summary>
public partial class BroadcasterSubscription : Resource, ITwitcherSharp<BroadcasterSubscription>
{
    ...
    /// <summary> 
    /// Transforms the godot data into a BroadcasterSubscription object.
    /// </summary> 
    public static BroadcasterSubscription FromObject(GodotObject data)
    {
        return new BroadcasterSubscription
        {
