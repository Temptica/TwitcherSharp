...
///  
/// </summary>
public partial class Channel : Resource, ITwitcherSharp<Channel>
{
    ...
    /// <summary> 
    /// Transforms the godot data into a Channel object.
    /// </summary> 
    public static Channel FromObject(GodotObject data)
    {
        return new Channel
        {
