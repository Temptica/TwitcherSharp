...
///  
/// </summary>
public partial class DropsEntitlement : Resource, ITwitcherSharp<DropsEntitlement>
{
    ...
    /// <summary> 
    /// Transforms the godot data into a DropsEntitlement object.
    /// </summary> 
    public static DropsEntitlement FromObject(GodotObject data)
    {
        return new DropsEntitlement
        {
