...
///  
/// </summary>
public partial class ExtensionTransaction : Resource, ITwitcherSharp<ExtensionTransaction>
{
    ...
    /// <summary> 
    /// Transforms the godot data into a ExtensionTransaction object.
    /// </summary> 
    public static ExtensionTransaction FromObject(GodotObject data)
    {
        return new ExtensionTransaction
        {
			...
			ProductData = data.Get("product_data").As<ProductData>(),
		};
	}
