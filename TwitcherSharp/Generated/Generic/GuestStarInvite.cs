...
///  
/// </summary>
public partial class GuestStarInvite : Resource, ITwitcherSharp<GuestStarInvite>
{
    ...
    /// <summary> 
    /// Transforms the godot data into a GuestStarInvite object.
    /// </summary> 
    public static GuestStarInvite FromObject(GodotObject data)
    {
        return new GuestStarInvite
        {
