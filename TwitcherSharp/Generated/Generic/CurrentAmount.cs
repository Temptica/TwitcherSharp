...
/// </summary>
public partial class CurrentAmount : Resource, ITwitcherSharp<CurrentAmount>
{
    ...
    /// <summary> 
    /// Transforms the godot data into a CurrentAmount object.
    /// </summary> 
    public static CurrentAmount FromObject(GodotObject data)
    {
        return new CurrentAmount
        {
