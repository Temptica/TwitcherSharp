...
///  
/// </summary>
public partial class CheermoteImageFormat : Resource, ITwitcherSharp<CheermoteImageFormat>
{
    ...
    /// <summary> 
    /// Transforms the godot data into a CheermoteImageFormat object.
    /// </summary> 
    public static CheermoteImageFormat FromObject(GodotObject data)
    {
        return new CheermoteImageFormat
        {
