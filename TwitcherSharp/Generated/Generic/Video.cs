...
///  
/// </summary>
public partial class Video : Resource, ITwitcherSharp<Video>
{
	...
	public MutedSegments[] MutedSegments { get; set; }
    /// <summary> 
    /// Transforms the godot data into a Video object.
    /// </summary> 
    public static Video FromObject(GodotObject data)
    {
        return new Video
        {
			...
			MutedSegments = data.Get("muted_segments").As<MutedSegments[]>(),
		};
	}
