...
///  
/// </summary>
public partial class Animated : Resource, ITwitcherSharp<Animated>
{
    ...
    /// <summary> 
    /// Transforms the godot data into a Animated object.
    /// </summary> 
    public static Animated FromObject(GodotObject data)
    {
        return new Animated
        {
