...
///  
/// </summary>
public partial class Prediction : Resource, ITwitcherSharp<Prediction>
{
    ...
    /// <summary> 
    /// Transforms the godot data into a Prediction object.
    /// </summary> 
    public static Prediction FromObject(GodotObject data)
    {
        return new Prediction
        {
			...
			Outcomes = data.Get("outcomes").As<PredictionOutcome[]>(),
