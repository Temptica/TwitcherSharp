...
/// The event’s data. 
/// </summary>
public partial class EventData : Resource, ITwitcherSharp<EventData>
{
    ...
    /// <summary> 
    /// Transforms the godot data into a EventData object.
    /// </summary> 
    public static EventData FromObject(GodotObject data)
    {
        return new EventData
        {
			...
			LastContribution = data.Get("last_contribution").As<LastContribution>(),
