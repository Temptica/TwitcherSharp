...
///  
/// </summary>
public partial class Team : Resource, ITwitcherSharp<Team>
{
    ...
    /// <summary> 
    /// Transforms the godot data into a Team object.
    /// </summary> 
    public static Team FromObject(GodotObject data)
    {
        return new Team
        {

			Users = data.Get("users").As<Users[]>(),
