...
///  
/// </summary>
public partial class ChannelTeam : Resource, ITwitcherSharp<ChannelTeam>
{
    ...
    /// <summary> 
    /// Transforms the godot data into a ChannelTeam object.
    /// </summary> 
    public static ChannelTeam FromObject(GodotObject data)
    {
        return new ChannelTeam
        {
