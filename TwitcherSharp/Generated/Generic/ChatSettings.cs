...
///  
/// </summary>
public partial class ChatSettings : Resource, ITwitcherSharp<ChatSettings>
{
    ...
    /// <summary> 
    /// Transforms the godot data into a ChatSettings object.
    /// </summary> 
    public static ChatSettings FromObject(GodotObject data)
    {
	...
	{
		var script = GD.Load<GDScript>("res://addons/twitcher/generated/twitch_chat_settings.gd");
