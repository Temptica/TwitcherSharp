...
/// </summary>
public partial class GlobalCooldownSetting : Resource, ITwitcherSharp<GlobalCooldownSetting>
{
    private GodotObject _data;
	public bool IsEnabled { get; set; }
	public int GlobalCooldownSeconds { get; set; }
    /// <summary> 
    /// Transforms the godot data into a GlobalCooldownSetting object.
    /// </summary> 
    public static GlobalCooldownSetting FromObject(GodotObject data)
    {
        return new GlobalCooldownSetting
        {
