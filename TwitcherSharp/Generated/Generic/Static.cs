...
///  
/// </summary>
public partial class Static : Resource, ITwitcherSharp<Static>
{
    ...
    /// <summary> 
    /// Transforms the godot data into a Static object.
    /// </summary> 
    public static Static FromObject(GodotObject data)
    {
        return new Static
        {
