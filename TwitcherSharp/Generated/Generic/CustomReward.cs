...
///  
/// </summary>
public partial class CustomReward : Resource, ITwitcherSharp<CustomReward>
{
    ...
    /// <summary> 
    /// Transforms the godot data into a CustomReward object.
    /// </summary> 
    public static CustomReward FromObject(GodotObject data)
    {
        return new CustomReward
        {
			...
			Image = data.Get("image").As<Image>(),
			DefaultImage = data.Get("default_image").As<DefaultImage>(),
			...
			MaxPerStreamSetting = data.Get("max_per_stream_setting").As<MaxPerStreamSetting>(),
			MaxPerUserPerStreamSetting = data.Get("max_per_user_per_stream_setting").As<MaxPerUserPerStreamSetting>(),
			GlobalCooldownSetting = data.Get("global_cooldown_setting").As<GlobalCooldownSetting>(),
