...
///  
/// </summary>
public partial class ExtensionBitsProduct : Resource, ITwitcherSharp<ExtensionBitsProduct>
{
    ...
    /// <summary> 
    /// Transforms the godot data into a ExtensionBitsProduct object.
    /// </summary> 
    public static ExtensionBitsProduct FromObject(GodotObject data)
    {
        return new ExtensionBitsProduct
        {
