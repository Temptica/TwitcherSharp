...
///  
/// </summary>
public partial class GetChannelGuestStarSettingsResponse : Resource, ITwitcherSharp<GetChannelGuestStarSettingsResponse>
{
    ...
    /// <summary> 
    /// Transforms the godot data into a GetChannelGuestStarSettingsResponse object.
    /// </summary> 
    public static GetChannelGuestStarSettingsResponse FromObject(GodotObject data)
    {
        return new GetChannelGuestStarSettingsResponse
        {
	...
	{
		var script = GD.Load<GDScript>("res://addons/twitcher/generated/twitch_get_channel_guest_star_settings_response.gd");
