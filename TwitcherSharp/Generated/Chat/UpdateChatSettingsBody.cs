...
///  
/// </summary>
public partial class UpdateChatSettingsBody : Resource, ITwitcherSharp<UpdateChatSettingsBody>
{
    ...
    /// <summary> 
    /// Transforms the godot data into a UpdateChatSettingsBody object.
    /// </summary> 
    public static UpdateChatSettingsBody FromObject(GodotObject data)
    {
        return new UpdateChatSettingsBody
        {
	...
	{
		var script = GD.Load<GDScript>("res://addons/twitcher/generated/twitch_update_chat_settings_body.gd");
