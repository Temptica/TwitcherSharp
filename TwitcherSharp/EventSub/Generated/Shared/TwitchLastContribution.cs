...
public partial class TwitchLastContribution : Resource, ITwitcherSharpEventSub<TwitchLastContribution>
{
	...
	public GodotObject ToGodotObject()
	{
		...
		var twitchLastContributionClass = script.Get("TwitchLastContribution").AsGodotObject();
		var request = twitchLastContributionClass.Call("new").AsGodotObject();
