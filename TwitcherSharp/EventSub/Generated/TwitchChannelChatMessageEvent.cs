...
public partial class TwitchChannelChatMessageEvent : Resource, ITwitcherSharpEventSub<TwitchChannelChatMessageEvent>
{
	...
	public static TwitchChannelChatMessageEvent FromData(Dictionary data)
	{
	    return new TwitchChannelChatMessageEvent
	    {
			...
			Cheer = TwitchCheer.FromData(data["cheer"].AsGodotDictionary()),
			Color = data["color"].AsString(),
			Reply = TwitchReply.FromData(data["reply"].AsGodotDictionary()),
...
public partial class TwitchCheer : Resource, ITwitcherSharpEventSub<TwitchCheer>
{
	...
	public static TwitchCheer FromData(Dictionary data)
	{
...
public partial class TwitchReply : Resource, ITwitcherSharpEventSub<TwitchReply>
{
	...
	public static TwitchReply FromData(Dictionary data)
	{
