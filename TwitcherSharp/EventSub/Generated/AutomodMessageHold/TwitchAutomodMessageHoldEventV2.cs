...
public partial class TwitchAutomodMessageHoldEventV2 : Resource, ITwitcherSharpEventSub<TwitchAutomodMessageHoldEventV2>
{
    ...
    public GodotObject ToGodotObject()
    {
        ...
        var automodMessageHoldEventV2V2Class = script.Get("AutomodMessageHoldEventV2V2").AsGodotObject();
        var request = automodMessageHoldEventV2V2Class.Call("new").AsGodotObject();
