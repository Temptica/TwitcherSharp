...
public partial class TwitchEventSubDefinition() : RefCounted, ITwitcherSharp<TwitchEventSubDefinition>
{
    ...
    public static readonly TwitchEventSubDefinition AutomodMessageHold = new(TwitchEventSubDefinitionType.AutomodMessageHold,
    ...
    public static readonly TwitchEventSubDefinition AutomodMessageUpdate = new(TwitchEventSubDefinitionType.AutomodMessageUpdate,
    ...
    public static readonly TwitchEventSubDefinition AutomodTermsUpdate = new(TwitchEventSubDefinitionType.AutomodTermsUpdate,
    ...
    public static readonly TwitchEventSubDefinition ChannelAdBreakBegin = new(TwitchEventSubDefinitionType.ChannelAdBreakBegin,
    ...
    public static readonly TwitchEventSubDefinition ChannelChatClear = new(TwitchEventSubDefinitionType.ChannelChatClear,
    ...
    public static readonly TwitchEventSubDefinition ChannelChatMessage = new(TwitchEventSubDefinitionType.ChannelChatMessage,
    ...
    public static readonly TwitchEventSubDefinition ChannelSubscribe = new(TwitchEventSubDefinitionType.ChannelSubscribe,
    ...
    public static readonly TwitchEventSubDefinition ChannelRaid = new(TwitchEventSubDefinitionType.ChannelRaid, "channel.raid",
        "1",
        ["to_broadcaster_user_id"], [], "https://dev.twitch.tv/docs/eventsub/eventsub-subscription-types/#channelraid");

    public static readonly TwitchEventSubDefinition ChannelBan = new(TwitchEventSubDefinitionType.ChannelBan, "channel.ban", "1",
    ...
    public static readonly TwitchEventSubDefinition ChannelModerateV2 = new(TwitchEventSubDefinitionType.ChannelModerateV2,
    ...
    public static readonly TwitchEventSubDefinition ChannelModeratorAdd = new(TwitchEventSubDefinitionType.ChannelModeratorAdd,
    ...
    public static readonly TwitchEventSubDefinition ChannelPollBegin = new(TwitchEventSubDefinitionType.ChannelPollBegin,
    ...
    public static readonly TwitchEventSubDefinition ChannelPollProgress = new(TwitchEventSubDefinitionType.ChannelPollProgress,
    ...
    public static readonly TwitchEventSubDefinition ChannelPredictionEnd = new(TwitchEventSubDefinitionType.ChannelPredictionEnd,
    ...
    public static readonly TwitchEventSubDefinition ChannelVipRemove = new(TwitchEventSubDefinitionType.ChannelVipRemove,
    ...
    public static readonly TwitchEventSubDefinition ChannelWarningSend = new(TwitchEventSubDefinitionType.ChannelWarningSend,
    ...
    public static readonly TwitchEventSubDefinition ChannelHypeTrainEnd = new(TwitchEventSubDefinitionType.ChannelHypeTrainEnd,
    ...
    public static readonly TwitchEventSubDefinition ChannelSharedChatEnd = new(TwitchEventSubDefinitionType.ChannelSharedChatEnd,
    ...
    public static readonly TwitchEventSubDefinition ChannelShieldModeEnd = new(TwitchEventSubDefinitionType.ChannelShieldModeEnd,
    ...
    public static readonly TwitchEventSubDefinition ConduitShardDisabled = new(TwitchEventSubDefinitionType.ConduitShardDisabled,
        "conduit.shard.disabled", "1", ["client_id"], [],
        "https://dev.twitch.tv/docs/eventsub/eventsub-subscription-types/#conduitsharddisabled");

    public static readonly TwitchEventSubDefinition DropEntitlementGrant = new(TwitchEventSubDefinitionType.DropEntitlementGrant,
    ...
    public static readonly TwitchEventSubDefinition ChannelGoalBegin = new(TwitchEventSubDefinitionType.ChannelGoalBegin,
    ...
    public static readonly TwitchEventSubDefinition ChannelGoalProgress = new(TwitchEventSubDefinitionType.ChannelGoalProgress,
    ...
    public static readonly TwitchEventSubDefinition UserUpdate = new(TwitchEventSubDefinitionType.UserUpdate, "user.update", "1",
        ["user_id"], ["user:read:email"],
        "https://dev.twitch.tv/docs/eventsub/eventsub-subscription-types/#userupdate");

    public static readonly TwitchEventSubDefinition UserWhisperMessage = new(TwitchEventSubDefinitionType.UserWhisperMessage,
